...
namespace Input
{
    class InputDevice : public Core::Interface::ITickable
    {
    public:
        ...
        CAERULUS_INPUT virtual void PreUpdate() override;
        CAERULUS_INPUT virtual void Update(float deltaTime) override {};
        CAERULUS_INPUT virtual void FixedUpdate(float fixedTime) override {};
        CAERULUS_INPUT virtual void PostUpdate() override {};
        CAERULUS_INPUT virtual void Reset() override {};
